...
<head>
  <meta charset="UTF-8">
  <title>Responsive Animated Nav!!!!!!!!!!!!!</title>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
      ...
      <li><a href="adminlogin.html">Admin Login</a><span class="hover"></span></li>
      <li><a href="login.html">Blog</a><span class="hover"></span></li>
      <li><a href="login.html">Contact</a><span class="hover"></span></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="well well-sm">
                <form class="form-horizontal" action="insert2.php" method="post">
                    <fieldset>
